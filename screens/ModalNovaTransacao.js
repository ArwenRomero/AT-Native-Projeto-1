...
export default function ModalTransacao({
  ...
  const buscarCotacao = async () => {
    ...
    setCotacao(resultadoCotacao ? resultadoCotacao.cotacaoCompra : 'Cotação indisponível');
  };
...
const styles = StyleSheet.create({
  ...
  modalContent: { width: '90%', padding: 20, backgroundColor: 'white', borderRadius: 15, elevation: 5 },
  input: { height: 50, borderColor: '#ddd', borderWidth: 1, borderRadius: 10, marginBottom: 15, paddingLeft: 15, fontSize: 16, color: '#333' },
  dataHoraBotao: { height: 50, backgroundColor: '#45b1f5', borderRadius: 10, justifyContent: 'center', alignItems: 'center', marginBottom: 15 },
  dataHoraTexto: { color: 'white', fontSize: 16 },
  picker: { height: 50, borderColor: '#ddd', borderWidth: 1, borderRadius: 10, marginBottom: 15, color: '#333' },
  cotacaoTexto: { fontSize: 16, color: '#007BFF', marginBottom: 15 },
  switchContainer: { flexDirection: 'row', alignItems: 'center', marginBottom: 15 },
  switchLabel: { fontSize: 16, marginRight: 10, color: '#333' },
});
